            ...
            {cards.map((card, idx) => (
              ...
              >
                ...
                <div className="relative p-6 flex flex-col items-center text-center">
                  ...
                  <motion.div
                    variants={scalePop}
                    className={`mb-5 flex h-14 w-14 items-center justify-center rounded-xl shadow-md ${card.iconBg}`}
                  >
                    {card.icon}
                  </motion.div>
                  ...
                  <motion.a
                    ...
                    className="inline-flex items-center rounded-full bg-brand-yellow px-5 py-2.5 text-sm font-semibold text-brand-black shadow"
                  >
                    {card.ctaText}
                  </motion.a>
                </div>
