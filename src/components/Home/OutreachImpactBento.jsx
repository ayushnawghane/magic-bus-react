    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 auto-rows-[220px] md:auto-rows-[220px] gap-6">
          {/* Large feature left (7 cols x 2 rows) */}
          <StoryCard
            tag="Livelihood"
            ...
            img="/ngo-images/1.JPG"
            className="md:col-span-7 md:row-span-2"
          />

          {/* Tall card right (5 cols x 2 rows) */}
          <StoryCard
            tag="WaSH"
          ...
          {/* Compact story tiles that sit below the hero row (each 6 cols on md+) */}
          <StoryCard
            tag="Healthcare"
        ...
        <div className="mt-10 grid md:grid-cols-4 gap-6 md:gap-8">
        ...
        {/* Your original 4-card impact grid - give more breathing room */}
        <div className="grid md:grid-cols-4 gap-8 mt-8 mb-6">
