          ...
          <div className="flex flex-col items-end justify-between gap-3 h-full">
            ...
            <div className="flex items-center gap-4 md:gap-6">
              ...
              <div className="hidden lg:flex items-center justify-center gap-2 mr-2">
                ...
                {/* Facebook */}
                <a href="https://facebook.com" target="_blank" rel="noreferrer" aria-label="Facebook" className="inline-flex items-center justify-center w-6 h-6 rounded-full shadow hover:scale-110 transition-transform" style={{ background: "#1877F2" }}>
                  <svg className="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* X */}
                <a href="https://x.com" target="_blank" rel="noreferrer" aria-label="X" className="inline-flex items-center justify-center w-6 h-6 rounded-full shadow hover:scale-110 transition-transform" style={{ background: "#000000" }}>
              ...
              <div className="flex items-stretch rounded-md overflow-hidden shadow-sm border border-slate-200/50">
                <div className="hidden sm:flex bg-brand-red text-white px-3 py-2 md:px-4 items-center gap-2 text-xs md:text-sm font-semibold">
                  <Globe className="w-3 h-3 md:w-4 md:h-4 text-white" />
                  <span>Magic Bus India</span>
                </div>
                <Link to="/donate" className="bg-brand-yellow text-brand-black px-4 py-2 md:px-5 flex items-center gap-2 text-xs md:text-sm font-bold hover:bg-brand-yellow/90 transition-colors">
                  <Heart className="w-3 h-3 md:w-4 md:h-4 fill-brand-black text-brand-black" />
                  Donate
                </Link>
              </div>
            ...
            <_MOTION.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.3 }} className="lg:hidden border-t border-slate-200 bg-white rounded-b-2xl overflow-hidden">
              <div className="px-6 py-4 space-y-4">
                ...
                <div className="pt-4 border-t border-slate-200 space-y-2">
                  <Link to="/donate" className="block w-full px-4 py-2 bg-brand-yellow text-brand-black text-center text-sm font-semibold rounded-lg" onClick={() => setMobileOpen(false)}>Donate Now</Link>
