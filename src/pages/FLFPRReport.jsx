 ...
 * Dedicated page for women's workforce participation research
 */
...
const FLFPR_REPORTS_DATA = [
  {
    ...
    year: "2023-24",
    description: "Comprehensive research on factors affecting women's participation in the labour force, barriers to employment, and the impact of our skill development programs on increasing FLFPR.",
    fileSize: "7.2 MB",
    pages: 110,
    downloadUrl: "#",
    featured: true,
  ...
  },
  {
    ...
    year: "2022-23",
    description: "Analysis of economic empowerment outcomes among women participants, focusing on skill development, employment generation, and entrepreneurship support.",
    fileSize: "6.1 MB",
    pages: 88,
    downloadUrl: "#",
    featured: false,
  ...
  },
  {
    ...
    year: "2021-22",
    description: "Focused study on challenges and opportunities for rural women's integration into the formal workforce, including digital literacy and market linkage programs.",
    fileSize: "5.8 MB",
    pages: 75,
    downloadUrl: "#",
    featured: false,
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      <img
        ...
        onError={(e) => {
          e.currentTarget.src = "https://images.unsplash.com/photo-1573164713714-d95e436ab8d6";
        }}
      />
      
      <div className="absolute inset-0 bg-gradient-to-r from-blue-900/90 via-indigo-900/70 to-transparent" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 h-full flex items-center">
        ...
        >
          ...
          <p className="mt-4 text-base md:text-lg text-white/90">
            Our FLFPR reports provide critical insights into women's labour force participation, 
            identifying barriers and showcasing how our programs create pathways to sustainable employment and economic empowerment.
          </p>

          <div className="mt-6">
            <motion.a
              href="#reports"
              className="group relative overflow-hidden rounded-full bg-blue-600 px-8 py-4 font-semibold text-white shadow-lg transition-all hover:shadow-2xl hover:shadow-blue-600/20 inline-flex items-center gap-2"
...
function FLFPRReportCard({ report, index }) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      transition={{ delay: index * 0.1 }}
      className="bg-white rounded-xl border border-slate-200 hover:border-blue-500/30 hover:shadow-lg transition-all duration-300 overflow-hidden group"
    >
      <div className="p-6">
        {/* Header */}
        ...
        {/* Title & Subtitle */}
        <h3 className="text-lg font-bold text-ink mb-1 line-clamp-2 group-hover:text-blue-600 transition-colors">
          {report.title}
        </h3>
        
        <p className="text-sm text-blue-600 font-medium mb-3">{report.subtitle}</p>
        ...
        {/* Sectors */}
        <div className="mb-4">
          <h4 className="text-xs font-semibold text-slate-700 mb-2 uppercase tracking-wide">Sectors</h4>
          <div className="flex flex-wrap gap-1">
            ...
            {report.sectors.length > 3 && (
              <span className="text-xs text-indigo-600 font-medium">+{report.sectors.length - 3}</span>
            )}
          </div>
        </div>
        ...
        <div className="mb-4 p-3 bg-blue-50 rounded-lg">
          <h4 className="text-xs font-semibold text-blue-800 mb-1 uppercase tracking-wide">Methodology</h4>
          <p className="text-xs text-blue-700">{report.methodology}</p>
        </div>
  ...
  return (
    <Layout>
      <main className="bg-slate-50 text-ink min-h-screen">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { title: "Barrier Analysis", icon: <BarChart3 className="w-8 h-8" />, desc: "Identifying systemic and individual barriers to employment" },
                { title: "Skill Assessment", icon: <Target className="w-8 h-8" />, desc: "Evaluating current skills and training needs" },
                { title: "Market Linkage", icon: <PieChart className="w-8 h-8" />, desc: "Connecting women to employment opportunities" },
                { title: "Impact Tracking", icon: <TrendingUp className="w-8 h-8" />, desc: "Measuring long-term employment outcomes" }
              ].map((area, index) => (
                <motion.div
                  key={area.title}
                  initial={{ opacity: 0, y: 30 }}
        ...
        {/* Call to Action */}
        <section className="py-16 bg-gradient-to-br from-blue-500 via-indigo-600 to-blue-700">
            ...
            >
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="bg-white text-blue-600 font-semibold px-6 py-3 rounded-xl hover:bg-white/90 transition-colors flex items-center gap-2"
                >
                  <Download className="w-4 h-4" />
